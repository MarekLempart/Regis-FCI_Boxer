...
const personTextData = [
    {
      id: "person1",
      description: "Zdjęcia do tej strony zostały wykonane przez Panią Martę Matczuk-Pisarek - utalentowanego fotografa, doktora nauk technicznych, pracownika samorządowego i wspaniałego człowieka",
    ...
    {
      id: "person2",
      description: "Jane Smith, an accomplished nature lover and conservationist.",
